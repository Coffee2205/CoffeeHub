...
- Real OpenAI/Groq/Gemini providers are implemented through the central AI SDK registry; Groq is the verified primary in the current environment.
...
- Planning relationships are server-derived by the Entity Resolver. Never accept model-generated UUIDs or bypass hierarchy validation.
- Reuse/link/extend existing planning entities by default; duplicate creation requires an explicit owner override.
