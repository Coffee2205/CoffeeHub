...
export type SaveState = "idle" | "saving" | "saved" | "failed" | "offline" | "syncing";
...
const states: Record<SaveState, { label: string; tone: string; dot: string }> = {
  ...
  saving: { label: "Đang lưu", tone: "text-info", dot: "bg-info animate-pulse" },
  ...
  syncing: { label: "Đang đồng bộ", tone: "text-accent-cyan", dot: "bg-accent-cyan animate-pulse" },
};
