...
export function EmptyState({
  ...
  return (
    <StateFrame
      ...
      icon={
        <span
          className="grid size-9 place-items-center rounded-sm border border-primary/25 bg-primary/10 text-lg text-blue-200"
          aria-hidden="true"
        >
          +
        </span>
...
export function ErrorState({
  ...
  return (
    <StateFrame
      ...
      icon={
        <span
          className="grid size-9 place-items-center rounded-full border border-error/30 bg-error/10 font-semibold text-error"
          aria-hidden="true"
        >
          !
        </span>
