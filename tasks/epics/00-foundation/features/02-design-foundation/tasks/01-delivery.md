# Task 01 — Design Foundation delivery

## Hierarchy

- Epic: `Foundation`
- Feature: `Design Foundation`
- Source roadmap item: `tasks/epics/00-foundation/features/02-design-foundation/FEATURE.md`
- Task path: `tasks/epics/00-foundation/features/02-design-foundation/tasks/01-delivery.md`
...
- `tasks/epics/00-foundation/features/01-repository-audit/FEATURE.md` phải hoàn thành.
