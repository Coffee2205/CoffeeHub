# Task 01 — Bootstrap delivery

## Hierarchy

- Epic: `Foundation`
- Feature: `Bootstrap`
- Source roadmap item: `tasks/epics/00-foundation/features/00-bootstrap/FEATURE.md`
- Task path: `tasks/epics/00-foundation/features/00-bootstrap/tasks/01-delivery.md`
