# Task 01 — Dashboard delivery

## Hierarchy

- Epic: `Owner Workspace`
- Feature: `Dashboard`
- Source roadmap item: `tasks/epics/02-owner-workspace/features/01-dashboard/FEATURE.md`
- Task path: `tasks/epics/02-owner-workspace/features/01-dashboard/tasks/01-delivery.md`
...
- `tasks/epics/00-foundation/features/05-authentication/FEATURE.md` đã hoàn thành.
