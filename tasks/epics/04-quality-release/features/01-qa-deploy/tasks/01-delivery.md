# Task 01 — QA and Deployment delivery

## Hierarchy

- Epic: `Quality and Release`
- Feature: `QA and Deployment`
- Source roadmap item: `tasks/epics/04-quality-release/features/01-qa-deploy/FEATURE.md`
- Task path: `tasks/epics/04-quality-release/features/01-qa-deploy/tasks/01-delivery.md`
...
- `tasks/epics/03-pwa-ai/features/04-ai-personal-assistant/FEATURE.md` phải hoàn thành.
